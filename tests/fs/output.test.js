...
import { buildPaths, createManifest, generateBuildId, sanitizeStoryId, writeManifest, } from '../../src/fs/output.js';
...
describe('output helpers', () => {
    ...
    it('builds consistent paths', () => {
        ...
        expect(paths.screenshotRelativePath).toBe('screenshots/20230102-030405/component_story.png');
    ...
    it('writes manifest with stable fields', async () => {
        ...
        expect(saved.stories[0].screenshotPath).toBe('screenshots/20230102-030405/example_story.png');
    });
});
