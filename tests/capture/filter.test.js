...
describe('filterStories', () => {
    it('returns all when no filters provided', () => {
        expect(filterStories(baseStories, undefined, undefined)).toEqual(baseStories);
    });
    ...
    it('combines include then exclude', () => {
        expect(filterStories(baseStories, ['button'], ['secondary'])).toEqual([{ storyId: 'button--primary' }]);
    });
});
