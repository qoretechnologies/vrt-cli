...
import { makeCaptureOptions, parseViewport } from '../../src/commands/capture.js';
describe('capture options helpers', () => {
    ...
    it('applies headful flag and includes/excludes', () => {
        const options = makeCaptureOptions({ headful: true, include: ['foo'], exclude: ['bar'], viewport: '1024x768' });
