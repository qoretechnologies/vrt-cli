...
import { CaptureOptions, CaptureRun, Story, StoryResult } from '../types.js';
...
export const captureStories = async ({
  ...
  stories,
  options,
}: CaptureInput): Promise<CaptureRun> => {
  ...
  const results: StoryResult[] = new Array(filteredStories.length);
      ...
      limiter(async () => {
        ...
        try {
          ...
          await page.screenshot({
            path: storyPaths.screenshotPath,
